...
export declare function findLastQueryCursor(collection: CollectionReference, queryBase: Query, params: messageTypes.IParamsGetList, resourceName: string, flogger: IFirestoreLogger): Promise<import("@firebase/firestore-types").QueryDocumentSnapshot<import("@firebase/firestore-types").DocumentData>>;
